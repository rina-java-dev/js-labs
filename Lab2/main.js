 ...
 * @property {string} transaction_date - Transaction date in format YYYY-MM-DD.
 * @property {number} transaction_amount - Transaction amount.
 * @property {"debit"|"credit"} transaction_type - Transaction type: debit (expense) or credit (income/refund).
 * @property {string} transaction_description - Transaction description.
 * @property {string} merchant_name - Merchant/service name.
 * @property {string} card_type - Card type / payment system name (e.g., Visa, MasterCard).
 */
...
console.log(
  ...
  calculateTotalAmountByDate(transactions, 2019, 1)
);

console.log(
  "getTransactionsByType (debit) count:",
  getTransactionsByType(transactions, "debit").length
);
...
console.log(
  ...
  getTransactionsByAmountRange(transactions, 50, 100).length
);
...
console.log(
  ...
  findMostTransactionMonth(transactions)
);
...
console.log(
  ...
  getTransactionsBeforeDate(transactions, "2019-02-01").length
);

console.log(
  "findTransactionById (id=10):",
  findTransactionById(transactions, "10")
);

console.log(
  "mapTransactionDescriptions (first 3):",
  mapTransactionDescriptions(transactions).slice(0, 3)
);
...
console.log(
  "getUniqueTransactionTypes:",
  getUniqueTransactionTypes(emptyTransactions)
);

console.log(
  "calculateTotalAmount:",
  calculateTotalAmount(emptyTransactions)
);

console.log(
  "calculateTotalAmountByDate:",
  calculateTotalAmountByDate(emptyTransactions, 2019)
);

console.log(
  "getTransactionsByType (debit):",
  getTransactionsByType(emptyTransactions, "debit")
);
...
console.log(
  ...
  getTransactionsByMerchant(emptyTransactions, "Cafe123")
);

console.log(
  "calculateAverageTransactionAmount:",
  calculateAverageTransactionAmount(emptyTransactions)
);

console.log(
  "getTransactionsByAmountRange:",
  getTransactionsByAmountRange(emptyTransactions, 50, 100)
);

console.log(
  "calculateTotalDebitAmount:",
  calculateTotalDebitAmount(emptyTransactions)
);

console.log(
  "findMostTransactionMonth:",
  findMostTransactionMonth(emptyTransactions)
);
...
console.log(
  "mostTransactionTypes:",
  mostTransactionTypes(emptyTransactions)
);

console.log(
  "getTransactionsBeforeDate:",
  getTransactionsBeforeDate(emptyTransactions, "2019-02-01")
);

console.log(
  "findTransactionById:",
  findTransactionById(emptyTransactions, "1")
);

console.log(
  "mapTransactionDescriptions:",
  mapTransactionDescriptions(emptyTransactions)
);
